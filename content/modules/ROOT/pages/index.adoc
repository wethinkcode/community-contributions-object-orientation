...
Content for the WeThinkCode curriculum site is written in asciidoc format. Asciidoc files require at least a title and a body. Asciidoc also expects headings to be in order. It is important to understand asciidoc syntax to be able to write content effectively. The reading section refers to an asciidoc syntax cheatsheet that you can refer to when writing your documents.
